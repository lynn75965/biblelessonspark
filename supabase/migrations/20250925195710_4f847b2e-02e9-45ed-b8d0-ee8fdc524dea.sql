...
-- Drop existing policies that allow users to update their own role
DROP POLICY IF EXISTS "profiles self update" ON public.profiles;

-- Create separate policies for different types of updates
-- Users can update their basic profile info but NOT role or founder_status
...
-- Add constraint to prevent excessive invite creation
