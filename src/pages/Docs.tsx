  ...
  const faqs = [
    {
      ...
      answer: "Approximately 76 seconds. BibleLessonSpark generates a complete 8-section lesson with 2,000-2,800 words of original content tailored to your specifications."
    },
    {
    ...
    },
    {
      ...
      answer: "We support all major translations. BibleLessonSpark will use Scripture references appropriate for your selected age group and theological tradition."
    },
    {
    ...
    },
    {
      ...
      answer: "Your selected theological lens invisibly guides BibleLessonSpark to align all content with your tradition's distinctives. The theology is woven naturally into the lesson rather than stated explicitly."
    }
  ];
