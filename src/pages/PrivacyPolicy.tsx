    ...
    <div className={BRANDING.layout.legalPageWrapper}>
      <div className={BRANDING.layout.legalPageCard}>
        ...
        <div className="prose prose-blue max-w-none space-y-6">
          <section>
            <h2 className="text-xl sm:text-2xl font-semibold text-foreground mb-3">Introduction</h2>
          ...
          <section>
            <h2 className="text-xl sm:text-2xl font-semibold text-foreground mb-3">Information We Collect</h2>
            
            <h3 className="text-lg sm:text-xl font-semibold text-foreground mb-2">Account Information</h3>
            ...
            <h3 className="text-lg sm:text-xl font-semibold text-foreground mb-2 mt-4">Generated Content</h3>
            <ul className="list-disc pl-6 text-foreground space-y-1">
            ...
            <h3 className="text-lg sm:text-xl font-semibold text-foreground mb-2 mt-4">Usage Information</h3>
            <ul className="list-disc pl-6 text-foreground space-y-1">
          ...
          <section>
            <h2 className="text-xl sm:text-2xl font-semibold text-foreground mb-3">How We Use Your Information</h2>
          ...
          <section>
            <h2 className="text-xl sm:text-2xl font-semibold text-foreground mb-3">Data Storage and Security</h2>
          ...
          <section>
            <h2 className="text-xl sm:text-2xl font-semibold text-foreground mb-3">Third-Party Services</h2>
            <p className="text-foreground mb-2">We use the following third-party services:</p>
            <ul className="list-disc pl-6 text-foreground space-y-2">
          ...
          <section>
            <h2 className="text-xl sm:text-2xl font-semibold text-foreground mb-3">Your Rights</h2>
          ...
          <section>
            <h2 className="text-xl sm:text-2xl font-semibold text-foreground mb-3">Data Retention</h2>
            <p className="text-foreground">
          ...
          <section>
            <h2 className="text-xl sm:text-2xl font-semibold text-foreground mb-3">Children's Privacy</h2>
            <p className="text-foreground">
          ...
          <section>
            <h2 className="text-xl sm:text-2xl font-semibold text-foreground mb-3">Changes to This Policy</h2>
            <p className="text-foreground">
          ...
          <section>
            <h2 className="text-xl sm:text-2xl font-semibold text-foreground mb-3">Contact Us</h2>
            <p className="text-foreground">
