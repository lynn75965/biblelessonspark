...
export const EXPORT_FORMATTING = {
  ...
  section8Title: "Section 8: Group Handout",
  /** Title for standalone Group Handout page (no "Section 8:" prefix -- teachers distribute to class) */
  section8StandaloneTitle: "Group Handout",
};

/**
 * SSOT: Resolve Section 8 standalone title from AudienceProfile participant.
 * Falls back to "Group Handout" for legacy lessons with no stored profile.
