              ...
              <div className="prose prose-sm max-w-none">
                {selectedDevotional.content?.split("\n").map((line, index) => {
                  if (line.startsWith("**") && line.endsWith("**")) {
                    return <h3 key={index} className="text-lg font-semibold mt-6 mb-3 text-primary">{line.replace(/\*\*/g, "")}</h3>;
                  }
          ...
          {sourceLesson && (
            <>
              ...
              <div className="prose prose-sm max-w-none mt-4">
                {sourceLesson.original_text?.split("\n").map((line: string, index: number) => {
                  if (line.startsWith("## ")) return <h2 key={index} className="text-lg font-bold mt-6 mb-3 text-primary">{line.replace("## ", "")}</h2>;
                  if (line.startsWith("**") && line.endsWith("**")) return <h3 key={index} className="text-base font-semibold mt-4 mb-2">{line.replace(/\*\*/g, "")}</h3>;
