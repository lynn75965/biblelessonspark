    ...
    Tables: {
      ...
      lessons: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "lessons_reshape_of_fkey"
            columns: ["reshape_of"]
            isOneToOne: false
            referencedRelation: "lessons"
            referencedColumns: ["id"]
      ...
      profiles: {
        Row: {
          ...
          full_name: string | null
          id: string
          include_group_handouts: boolean | null
          ...
          trial_full_lessons_used: number
          trial_period_start: string | null
          trial_short_lessons_used: number
      ...
      reshape_metrics: {
        Row: {
          ...
          lesson_id: string
          rate_limited: boolean | null
          reshape_duration_ms: number | null
          reshape_end: string | null
          reshape_start: string
          shape_id: string
          status: string
          tokens_input: number | null
          tokens_output: number | null
        ...
        Relationships: [
          {
            foreignKeyName: "reshape_metrics_lesson_id_fkey"
            columns: ["lesson_id"]
            isOneToOne: false
            referencedRelation: "lessons"
            referencedColumns: ["id"]
      ...
      teaching_team_members: {
        ...
        Relationships: [
          {
            foreignKeyName: "teaching_team_members_team_id_fkey"
            columns: ["team_id"]
            isOneToOne: false
            referencedRelation: "teaching_teams"
            referencedColumns: ["id"]
          },
        ]
      }
