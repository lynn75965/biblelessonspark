// ============================================================
// BIBLELESSONSPARK - PRICING CONFIGURATION (SSOT-COMPLIANT)
...
// ============================================================
// SECTION ARRAYS - THE SINGLE SOURCE OF TRUTH
// ============================================================
// These arrays define which lesson sections each tier receives.
// Import these constants - NEVER hardcode [1, 5, 8] or similar.
// ============================================================

// Section mappings - App-controlled (as strings)
