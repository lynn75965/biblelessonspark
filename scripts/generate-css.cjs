 ...
 *
 * SSOT FLOW:
 *   src/config/brand-values.json → generate-css.cjs → index.css → Tailwind → Build
 *
 * TO CHANGE COLORS/FONTS: Edit src/config/brand-values.json, then rebuild.
 * brand-values.json is the ONLY place colors and fonts are defined.
 */
...
// =============================================================================
// LOAD SINGLE SOURCE OF TRUTH FROM JSON
// =============================================================================

const brandValuesPath = path.join(__dirname, '../src/config/brand-values.json');
const brandValues = JSON.parse(fs.readFileSync(brandValuesPath, 'utf8'));

// Map JSON structure to flat BRAND object for compatibility
const BRAND = {
  // Colors
  primary: brandValues.colors.primary.DEFAULT,
  secondary: brandValues.colors.secondary.DEFAULT,
  accent: brandValues.colors.accent.DEFAULT,
  destructive: brandValues.colors.destructive.DEFAULT,
  background: brandValues.colors.background.primary,
  backgroundSecondary: brandValues.colors.background.secondary,
  textPrimary: brandValues.colors.text.primary,
  textSecondary: brandValues.colors.text.secondary,
  textMuted: brandValues.colors.text.muted,
  ...
  fontSecondary: brandValues.typography.fontFamily.secondary,
  fontUrl: brandValues.typography.googleFontsUrl,

  // Font sizes (for reference)
  fontSize: brandValues.typography.fontSize,
};
 ...
 *
 * SSOT: To change colors/fonts, edit src/config/brand-values.json
 * Then run: npm run build
 *
 * Generated by scripts/generate-css.cjs
 *
 * Color Reference:
...
@layer base {
  :root {
    ...
    --font-size-xs: ${BRAND.fontSize.xs};
    --font-size-sm: ${BRAND.fontSize.sm};
    --font-size-base: ${BRAND.fontSize.base};
    --font-size-lg: ${BRAND.fontSize.lg};
    --font-size-xl: ${BRAND.fontSize.xl};
    --font-size-2xl: ${BRAND.fontSize['2xl']};
    --font-size-3xl: ${BRAND.fontSize['3xl']};
    --font-size-4xl: ${BRAND.fontSize['4xl']};
...
/* Wide scrollbar for accessibility */
::-webkit-scrollbar {
  width: 16px;
}
...
console.log('');
console.log('   Source: src/config/brand-values.json');
console.log('');
...
console.log('');
console.log('   To change: Edit src/config/brand-values.json, then run: npm run build');
console.log('');
